...
class GoogleIconFont:
    ...
    def load(cls):
        ...
        font_path = resource_path(cls.FILE_NAME)
...
PALETTES = {
    "Blue": {"main": "#1a73e8", "bg": ("#f0f4f8", "#111418"), "card": ("#d3e3fd", "#1e242c"),
             "entry": ("#ffffff", "#15191e"), "text": ("#041e49", "#d3e3fd")},
    "Green": {"main": "#34a853", "bg": ("#f0f7f1", "#101612"), "card": ("#c4eed0", "#1a231d"),
              "entry": ("#ffffff", "#141b16"), "text": ("#072711", "#c4eed0")},
    "Purple": {"main": "#a142f4", "bg": ("#f8f4fb", "#161219"), "card": ("#eaddff", "#2b2131"),
               "entry": ("#ffffff", "#1d1721"), "text": ("#21005d", "#eaddff")},
    "Orange": {"main": "#fbbc04", "bg": ("#fff8f4", "#1a1612"), "card": ("#ffdf99", "#2e2418"),
               "entry": ("#ffffff", "#211a14"), "text": ("#291a00", "#ffdf99")},
    "Black": {"main": "#404040", "bg": ("#f4f4f4", "#121212"), "card": ("#e3e3e3", "#1e1e1e"),
              "entry": ("#ffffff", "#171717"), "text": ("#000000", "#e3e3e3")}
}
...
class App(ctk.CTk):
    ...
    def build_main_screen(self):
        ...
        self.title_label = ctk.CTkLabel(self.main_frame, text="KegeAnsw", font=(FONT_MAIN, 28, "bold"),
        ...
        self.output_area = ctk.CTkTextbox(self.output_card, font=("Courier New", 15), fg_color="transparent",
                                          text_color=colors["text"])
    ...
    def build_settings_popup(self):
        ...
        self.settings_title = ctk.CTkLabel(self.settings_frame, text="Настройки", font=(FONT_MAIN, 22, "bold"),
                                           text_color=colors["text"])
        self.settings_title.pack(pady=(40, 30))

        self.theme_label = ctk.CTkLabel(self.settings_frame, text="Режим оформления:", font=(FONT_MAIN, 14),
                                        text_color=colors["text"])
        ...
        self.accent_label = ctk.CTkLabel(self.settings_frame, text="Акцентный цвет:", font=(FONT_MAIN, 14),
                                         text_color=colors["text"])
    ...
    def fetch_answers(self, event=None):
        ...
        try:
            r = requests.get(f"https://kompege.ru/api/v1/variant/kim/{variant_id}", timeout=10)
            data = r.json()
